...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/auth/register', {
      ...
      body: JSON.stringify({ username: form.username, password: form.password, phone: form.phone }),
    })
    ...
    <div className="section flex min-h-[calc(100vh-48px)] items-center justify-center py-10">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-muted">Займёт 30 секунд</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="card space-y-4 p-6">
          ...
          <div>
            ...
            <div className="relative">
              <input className="input !pr-10" type={showPw ? 'text' : 'password'} placeholder="Минимум 6 символов" value={form.password}
